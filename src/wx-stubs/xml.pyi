...
class XmlDocument(wx.Object):
    ...
    def GetFileType(self) -> wx.TextFileType:
        """
        GetFileType() -> wx.TextFileType
    ...
    def SetFileType(self, fileType: wx.TextFileType) -> None:
        """
    ...
    @property
    def FileType(self) -> wx.TextFileType: ...
    @FileType.setter
    def FileType(self, value: wx.TextFileType, /) -> None: ...
    @property
