...
wxEVT_DATAVIEW_SELECTION_CHANGED: wx.EventType
wxEVT_DATAVIEW_ITEM_ACTIVATED: wx.EventType
wxEVT_DATAVIEW_ITEM_COLLAPSING: wx.EventType
wxEVT_DATAVIEW_ITEM_COLLAPSED: wx.EventType
wxEVT_DATAVIEW_ITEM_EXPANDING: wx.EventType
wxEVT_DATAVIEW_ITEM_EXPANDED: wx.EventType
wxEVT_DATAVIEW_ITEM_START_EDITING: wx.EventType
wxEVT_DATAVIEW_ITEM_EDITING_STARTED: wx.EventType
wxEVT_DATAVIEW_ITEM_EDITING_DONE: wx.EventType
wxEVT_DATAVIEW_ITEM_VALUE_CHANGED: wx.EventType
wxEVT_DATAVIEW_ITEM_CONTEXT_MENU: wx.EventType
wxEVT_DATAVIEW_COLUMN_HEADER_CLICK: wx.EventType
wxEVT_DATAVIEW_COLUMN_HEADER_RIGHT_CLICK: wx.EventType
wxEVT_DATAVIEW_COLUMN_SORTED: wx.EventType
wxEVT_DATAVIEW_COLUMN_REORDERED: wx.EventType
wxEVT_DATAVIEW_CACHE_HINT: wx.EventType
wxEVT_DATAVIEW_ITEM_BEGIN_DRAG: wx.EventType
wxEVT_DATAVIEW_ITEM_DROP_POSSIBLE: wx.EventType
wxEVT_DATAVIEW_ITEM_DROP: wx.EventType
...
class DataViewIconText(wx.Object):
    ...
    def SetBitmapBundle(self, bitmap: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]) -> None:
        """
    ...
    @BitmapBundle.setter
    def BitmapBundle(self, value: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon], /) -> None: ...
    @property
...
class DataViewTreeCtrl(DataViewCtrl):
    ...
    def SetItemExpandedIcon(self, item: DataViewItem, icon: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]) -> None:
        """
    ...
    def SetItemIcon(self, item: DataViewItem, icon: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]) -> None:
        """
...
class DataViewTreeStore(DataViewModel):
    ...
    def AppendContainer(self, parent: DataViewItem, text: str, icon: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]=wx.BitmapBundle(), expanded: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]=wx.BitmapBundle(), data: Optional[ClientData]=None) -> DataViewItem:
        """
    ...
    def AppendItem(self, parent: DataViewItem, text: str, icon: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]=wx.BitmapBundle(), data: Optional[ClientData]=None) -> DataViewItem:
        """
    ...
    def InsertContainer(self, parent: DataViewItem, previous: DataViewItem, text: str, icon: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]=wx.BitmapBundle(), expanded: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]=wx.BitmapBundle(), data: Optional[ClientData]=None) -> DataViewItem:
        """
    ...
    def InsertItem(self, parent: DataViewItem, previous: DataViewItem, text: str, icon: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]=wx.BitmapBundle(), data: Optional[ClientData]=None) -> DataViewItem:
        """
    ...
    def PrependContainer(self, parent: DataViewItem, text: str, icon: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]=wx.BitmapBundle(), expanded: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]=wx.BitmapBundle(), data: Optional[ClientData]=None) -> DataViewItem:
        """
    ...
    def PrependItem(self, parent: DataViewItem, text: str, icon: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]=wx.BitmapBundle(), data: Optional[ClientData]=None) -> DataViewItem:
        """
...
wxEVT_TREELIST_SELECTION_CHANGED: wx.EventType
wxEVT_TREELIST_ITEM_EXPANDING: wx.EventType
wxEVT_TREELIST_ITEM_EXPANDED: wx.EventType
wxEVT_TREELIST_ITEM_CHECKED: wx.EventType
wxEVT_TREELIST_ITEM_ACTIVATED: wx.EventType
wxEVT_TREELIST_ITEM_CONTEXT_MENU: wx.EventType
wxEVT_TREELIST_COLUMN_SORTED: wx.EventType
...
class TreeListCtrl(wx.Window):
    ...
    @property
    def SortColumn(self) -> tuple[bool, int, bool]: ...
    @SortColumn.setter
    def SortColumn(self, value: tuple[bool, int, bool], /) -> None: ...
    @property
