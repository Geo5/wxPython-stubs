...
wxEVT_AUI_PANE_BUTTON: wx.EventType
wxEVT_AUI_PANE_CLOSE: wx.EventType
wxEVT_AUI_PANE_MAXIMIZE: wx.EventType
wxEVT_AUI_PANE_RESTORE: wx.EventType
wxEVT_AUI_PANE_ACTIVATED: wx.EventType
wxEVT_AUI_RENDER: wx.EventType
wxEVT_AUI_FIND_MANAGER: wx.EventType
...
class AuiPaneInfo:
    ...
    def Icon(self, b: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]) -> AuiPaneInfo:
        """
        Icon(b) -> AuiPaneInfo
...
class AuiManagerEvent(wx.Event):
    ...
    def __init__(self, type: wx.EventType=wx.wxEVT_NULL) -> None:
        """
        AuiManagerEvent(type=wx.wxEVT_NULL) -> None
...
wxEVT_AUITOOLBAR_TOOL_DROPDOWN: wx.EventType
wxEVT_AUITOOLBAR_OVERFLOW_CLICK: wx.EventType
wxEVT_AUITOOLBAR_RIGHT_CLICK: wx.EventType
wxEVT_AUITOOLBAR_MIDDLE_CLICK: wx.EventType
wxEVT_AUITOOLBAR_BEGIN_DRAG: wx.EventType
...
class AuiToolBarItem:
    ...
    def SetDisabledBitmap(self, bmp: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]) -> None:
        """
    ...
    def SetHoverBitmap(self, bmp: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]) -> None:
        """
    ...
    @property
    def DisabledBitmap(self) -> wx.Bitmap: ...
    @DisabledBitmap.setter
    def DisabledBitmap(self, value: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon], /) -> None: ...
    @property
    def HoverBitmap(self) -> wx.Bitmap: ...
    @HoverBitmap.setter
    def HoverBitmap(self, value: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon], /) -> None: ...
    @property
    def Id(self) -> int: ...
    @Id.setter
...
class AuiToolBar(wx.Control):
    ...
    def SetToolBitmap(self, toolId: int, bitmap: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]) -> None:
        """
...
wxEVT_AUINOTEBOOK_PAGE_CLOSE: wx.EventType
wxEVT_AUINOTEBOOK_PAGE_CHANGED: wx.EventType
wxEVT_AUINOTEBOOK_PAGE_CHANGING: wx.EventType
wxEVT_AUINOTEBOOK_PAGE_CLOSED: wx.EventType
wxEVT_AUINOTEBOOK_BUTTON: wx.EventType
wxEVT_AUINOTEBOOK_BEGIN_DRAG: wx.EventType
wxEVT_AUINOTEBOOK_END_DRAG: wx.EventType
wxEVT_AUINOTEBOOK_DRAG_MOTION: wx.EventType
wxEVT_AUINOTEBOOK_ALLOW_DND: wx.EventType
wxEVT_AUINOTEBOOK_TAB_MIDDLE_DOWN: wx.EventType
wxEVT_AUINOTEBOOK_TAB_MIDDLE_UP: wx.EventType
wxEVT_AUINOTEBOOK_TAB_RIGHT_DOWN: wx.EventType
wxEVT_AUINOTEBOOK_TAB_RIGHT_UP: wx.EventType
wxEVT_AUINOTEBOOK_DRAG_DONE: wx.EventType
wxEVT_AUINOTEBOOK_BG_DCLICK: wx.EventType
...
class AuiNotebook(wx.BookCtrlBase):
    ...
    def SetPageBitmap(self, page: int, bitmap: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]) -> bool:
        """
...
class AuiTabContainer:
    ...
    def AddButton(self, id: int, location: int, normalBitmap: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]=wx.BitmapBundle(), disabledBitmap: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]=wx.BitmapBundle()) -> None:
        """
    ...
    @ActivePage.setter
    def ActivePage(self, value: Union[wx.Window, int], /) -> None: ...
    @property
    def ArtProvider(self) -> AuiTabArt: ...
    @ArtProvider.setter
    def ArtProvider(self, value: AuiTabArt, /) -> None: ...
...
class AuiTabArt:
    ...
    def GetTabSize(self, dc: wx.DC, wnd: wx.Window, caption: str, bitmap: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon], active: bool, close_button_state: int, x_extent: int) -> wx.Size:
        """
...
class AuiNotebookEvent(wx.BookCtrlEvent):
    ...
    def __init__(self, command_type: wx.EventType=wx.wxEVT_NULL, win_id: int=0) -> None:
        """
        AuiNotebookEvent(command_type=wx.wxEVT_NULL, win_id=0) -> None
