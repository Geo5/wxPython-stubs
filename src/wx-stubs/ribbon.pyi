...
wxEVT_RIBBONPANEL_EXTBUTTON_ACTIVATED: wx.EventType
...
class RibbonPanelEvent(wx.CommandEvent):
    ...
    def __init__(self, command_type: wx.EventType=wx.wxEVT_NULL, win_id: int=0, panel: Optional[RibbonPanel]=None) -> None:
        """
        RibbonPanelEvent(command_type=wx.wxEVT_NULL, win_id=0, panel=None) -> None
...
wxEVT_RIBBONBAR_PAGE_CHANGED: wx.EventType
wxEVT_RIBBONBAR_PAGE_CHANGING: wx.EventType
wxEVT_RIBBONBAR_TAB_MIDDLE_DOWN: wx.EventType
wxEVT_RIBBONBAR_TAB_MIDDLE_UP: wx.EventType
wxEVT_RIBBONBAR_TAB_RIGHT_DOWN: wx.EventType
wxEVT_RIBBONBAR_TAB_RIGHT_UP: wx.EventType
wxEVT_RIBBONBAR_TAB_LEFT_DCLICK: wx.EventType
wxEVT_RIBBONBAR_TOGGLED: wx.EventType
wxEVT_RIBBONBAR_HELP_CLICK: wx.EventType
...
class RibbonBarEvent(wx.NotifyEvent):
    ...
    def __init__(self, command_type: wx.EventType=wx.wxEVT_NULL, win_id: int=0, page: Optional[RibbonPage]=None) -> None:
        """
        RibbonBarEvent(command_type=wx.wxEVT_NULL, win_id=0, page=None) -> None
...
class RibbonBar(RibbonControl):
    ...
    @ActivePage.setter
    def ActivePage(self, value: Union[int, RibbonPage], /) -> None: ...
    @property
...
wxEVT_RIBBONBUTTONBAR_CLICKED: wx.EventType
wxEVT_RIBBONBUTTONBAR_DROPDOWN_CLICKED: wx.EventType
...
class RibbonButtonBarEvent(wx.CommandEvent):
    ...
    def __init__(self, command_type: wx.EventType=wx.wxEVT_NULL, win_id: int=0, bar: Optional[RibbonButtonBar]=None, button: Optional[RibbonButtonBarButtonBase]=None) -> None:
        """
        RibbonButtonBarEvent(command_type=wx.wxEVT_NULL, win_id=0, bar=None, button=None) -> None
...
wxEVT_RIBBONGALLERY_HOVER_CHANGED: wx.EventType
wxEVT_RIBBONGALLERY_SELECTED: wx.EventType
wxEVT_RIBBONGALLERY_CLICKED: wx.EventType
...
class RibbonGalleryEvent(wx.CommandEvent):
    ...
    def __init__(self, command_type: wx.EventType=wx.wxEVT_NULL, win_id: int=0, gallery: Optional[RibbonGallery]=None, item: Optional[RibbonGalleryItem]=None) -> None:
        """
        RibbonGalleryEvent(command_type=wx.wxEVT_NULL, win_id=0, gallery=None, item=None) -> None
        """
...
wxEVT_RIBBONTOOLBAR_CLICKED: wx.EventType
wxEVT_RIBBONTOOLBAR_DROPDOWN_CLICKED: wx.EventType
...
class RibbonToolBarEvent(wx.CommandEvent):
    ...
    def __init__(self, command_type: wx.EventType=wx.wxEVT_NULL, win_id: int=0, bar: Optional[RibbonToolBar]=None) -> None:
        """
        RibbonToolBarEvent(command_type=wx.wxEVT_NULL, win_id=0, bar=None) -> None
        """
