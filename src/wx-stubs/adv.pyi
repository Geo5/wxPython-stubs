...
#-- begin-dateevt --#
wxEVT_DATE_CHANGED: wx.EventType
wxEVT_TIME_CHANGED: wx.EventType
...
class DateEvent(wx.CommandEvent):
    ...
    def SetDate(self, date: Union[wx.DateTime, datetime, date]) -> None:
        """
        SetDate(date) -> None
    ...
    @Date.setter
    def Date(self, value: Union[wx.DateTime, datetime, date], /) -> None: ...
...
class DatePickerCtrl(wx.Control):
    ...
    def SetRange(self, dt1: Union[wx.DateTime, datetime, date], dt2: Union[wx.DateTime, datetime, date]) -> None:
        """
    ...
    def SetValue(self, dt: Union[wx.DateTime, datetime, date]) -> None:
        """
        SetValue(dt) -> None
    ...
    @Value.setter
    def Value(self, value: Union[wx.DateTime, datetime, date], /) -> None: ...
...
wxEVT_CALENDAR_SEL_CHANGED: wx.EventType
wxEVT_CALENDAR_PAGE_CHANGED: wx.EventType
wxEVT_CALENDAR_DOUBLECLICKED: wx.EventType
wxEVT_CALENDAR_WEEKDAY_CLICKED: wx.EventType
wxEVT_CALENDAR_WEEK_CLICKED: wx.EventType
wxEVT_CALENDAR_YEAR_CHANGED: wx.EventType
wxEVT_CALENDAR_MONTH_CHANGED: wx.EventType
wxEVT_CALENDAR_DAY_CHANGED: wx.EventType
...
class CalendarCtrl(wx.Control):
    ...
    def SetDateRange(self, lowerdate: Union[wx.DateTime, datetime, date]=wx.DefaultDateTime, upperdate: Union[wx.DateTime, datetime, date]=wx.DefaultDateTime) -> bool:
        """
    ...
    def SetDate(self, date: Union[wx.DateTime, datetime, date]) -> bool:
        """
        SetDate(date) -> bool
    ...
    def Date(self, value: Union[wx.DateTime, datetime, date], /) -> None: ...
    @property
    def DateRange(self) -> tuple[bool, wx.DateTime, wx.DateTime]: ...
    @DateRange.setter
    def DateRange(self, value: tuple[bool, wx.DateTime, wx.DateTime], /) -> None: ...
    @property
...
wxEVT_TASKBAR_MOVE: wx.EventType
wxEVT_TASKBAR_LEFT_DOWN: wx.EventType
wxEVT_TASKBAR_LEFT_UP: wx.EventType
wxEVT_TASKBAR_RIGHT_DOWN: wx.EventType
wxEVT_TASKBAR_RIGHT_UP: wx.EventType
wxEVT_TASKBAR_LEFT_DCLICK: wx.EventType
wxEVT_TASKBAR_RIGHT_DCLICK: wx.EventType
wxEVT_TASKBAR_CLICK: wx.EventType
wxEVT_TASKBAR_BALLOON_TIMEOUT: wx.EventType
wxEVT_TASKBAR_BALLOON_CLICK: wx.EventType
...
class TaskBarIconEvent(wx.Event):
    ...
    def __init__(self, evtType: wx.EventType, tbIcon: TaskBarIcon) -> None:
        """
        TaskBarIconEvent(evtType, tbIcon) -> None
...
class TaskBarIcon(wx.EvtHandler):
    ...
    def SetIcon(self, icon: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon], tooltip: str='') -> bool:
        """
...
class AnimationCtrl(wx.Control):
    ...
    def SetInactiveBitmap(self, bmp: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]) -> None:
        """
    ...
    @property
    def InactiveBitmap(self) -> wx.Bitmap: ...
    @InactiveBitmap.setter
    def InactiveBitmap(self, value: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon], /) -> None: ...
...
class BannerWindow(wx.Window):
    ...
    def SetBitmap(self, bmp: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]) -> None:
        """
        SetBitmap(bmp) -> None
...
#-- end-editlbox --#
#-- begin-notifmsg --#
wxEVT_NOTIFICATION_MESSAGE_CLICK: wx.EventType
wxEVT_NOTIFICATION_MESSAGE_DISMISSED: wx.EventType
wxEVT_NOTIFICATION_MESSAGE_ACTION: wx.EventType
...
wxEVT_SASH_DRAGGED: wx.EventType
...
wxEVT_QUERY_LAYOUT_INFO: wx.EventType
wxEVT_CALCULATE_LAYOUT: wx.EventType
...
class BitmapComboBox(wx.Control, wx.TextEntry, wx.ItemContainer):
    ...
    def SetItemBitmap(self, n: int, bitmap: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]) -> None:
        """
...
WIZARD_TILE: int
wxEVT_WIZARD_PAGE_CHANGED: wx.EventType
wxEVT_WIZARD_PAGE_CHANGING: wx.EventType
wxEVT_WIZARD_CANCEL: wx.EventType
wxEVT_WIZARD_HELP: wx.EventType
wxEVT_WIZARD_FINISHED: wx.EventType
wxEVT_WIZARD_PAGE_SHOWN: wx.EventType
wxEVT_WIZARD_BEFORE_PAGE_CHANGED: wx.EventType
...
class WizardPage(wx.Panel):
    ...
    def Create(self, parent: Wizard, bitmap: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]=wx.BitmapBundle()) -> bool:
        """
...
class WizardPageSimple(WizardPage):
    ...
    def Create(self, parent: Optional[Wizard]=None, prev: Optional[WizardPage]=None, next: Optional[WizardPage]=None, bitmap: Union[wx.BitmapBundle, wx.Bitmap, wx.Icon]=wx.BitmapBundle()) -> bool:
        """
...
class WizardEvent(wx.NotifyEvent):
    ...
    def __init__(self, type: wx.EventType=wx.wxEVT_NULL, id: int=wx.ID_ANY, direction: bool=True, page: WizardPage=0) -> None:
        """
        WizardEvent(type=wx.wxEVT_NULL, id=wx.ID_ANY, direction=True, page=0) -> None
